...
data class QuizItemTagsQuizzesView(
	...
	@Column("item_description") val itemDescription: String?,
	@Column("item_image_id") val itemImageId: String?,
	@Column("item_question") val itemQuestion: String,
	@Column("item_options") val itemOptions: List<String>,
	@Column("item_key") val itemKey: Short,
	@Column("item_story") val itemStory: StoryView?,
	@Column("item_created_at") val itemCreatedAt: Instant,
	@Column("item_version") val itemVersion: Int?,

	@Column("item_tags") val itemTags: List<String>,

	@Column("item_quizzes") val itemQuizzes: List<QuizView>
)
...
data class QuizView(
	...
	val quizChannelId: UUID,
	val quizAuthorId: UUID?,
	val quizCreatedAt: Instant,
	val quizPublishedAt: Instant,
	val version: Int
)